...
namespace EFund.DAL.Migrations
{
    ...
    [Migration("20250530223431_AddFundraisingReview")]
    partial class AddFundraisingReview
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ComplaintViolation", b =>
                {
                    b.Property<Guid>("ComplaintsId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("ViolationsId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("ComplaintsId", "ViolationsId");

                    b.HasIndex("ViolationsId");

                    b.ToTable("ComplaintViolation");
                });
            ...
            modelBuilder.Entity("EFund.DAL.Entities.Complaint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EFund.DAL.Entities.FundraisingReview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EFund.DAL.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EFund.DAL.Entities.Violation", b =>
                {
                    ...
                    b.Property<decimal>("RatingImpact")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("ComplaintViolation", b =>
                {
                    b.HasOne("EFund.DAL.Entities.Complaint", null)
                        .WithMany()
                        .HasForeignKey("ComplaintsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EFund.DAL.Entities.Violation", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EFund.DAL.Entities.Complaint", b =>
                {
                    ...
                    b.HasOne("EFund.DAL.Entities.User", "RequestedByUser")
                        .WithMany()
                        .HasForeignKey("RequestedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EFund.DAL.Entities.User", "RequestedForUser")
                        .WithMany()
                        .HasForeignKey("RequestedFor")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EFund.DAL.Entities.User", "ReviewedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("EFund.DAL.Entities.FundraisingReview", b =>
                {
                    ...
                    b.HasOne("EFund.DAL.Entities.User", "ReviwedByUser")
                        .WithMany()
                        .HasForeignKey("ReviewedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
